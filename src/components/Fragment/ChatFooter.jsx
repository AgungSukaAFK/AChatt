  ...
  function sendChat(e){
    ...
    if(input.chat){
      axios.post(api, inputJson, {
        ...
        }, 1000); // Kenapa di set timeout? karena saat ini di scroll, heightnya akan mengacu pada halaman sebelum ditambah chat baru, maka dari itu perlu menunggu sampai chat baru dirender
      }).catch(err => {
        console.log(err)
      })
    }
